...
function ScrollSection(A, B, D) {
	document.getElementById("searchLogo").style.display="";
	document.getElementById("searchResult").style.display="none";
	document.getElementById("baidu_1").style.display="";
	document.getElementById("baidu_2").style.display="";
...
G.SO = {
    initData: {
        web: ["web", "网页", [["中搜", "http://www.zhongsou.com/third.cgi?w={key}"],["百度", "http://www.baidu.com/s?tn=chnliver_pg&wd={key}"],["搜狗", "http://www.sogou.com/web?query={key}&_ast=1234423248"],["有道", "http://www.youdao.com/search?q={key}"],["Bing", "http://cn.bing.com/search?q={key}"],["雅虎", "http://one.cn.yahoo.com/s?p={key}"]]],
        widget: ["widget", "软件", [ ["华军", "http://search.newhua.com/search.asp?Keyword={key}"], ["天空", "http://www.skycn.com/search.php?sf=search&ss_name={key}"],["360软件", "http://baoku.360.cn/soft/search?kw=={key}&encode=utf-8"], ["狗狗", "http://soft.gougou.com/search?search={key}&restype=2&id=1{encode}"], ["下载吧", "http://www.xiazaiba.com/word/{key}"]]],
        video: ["video", "视频", [["优酷", "http://so.youku.com/search_video/q_{key}"], ["土豆", "http://so.tudou.com/isearch.do?kw={key}"], ["百度", "http://video.baidu.com/v?ct=301989888&rn=20&pn=0&db=0&s=7&word={key}"], ["有道", "http://video.youdao.com/search?q={key}"], ["搜狗", "http://v.sogou.com/v?query={key}"]]],
        mp3: ["mp3", "音乐", [["百度", "http://mp3.baidu.com/m?tn=baidump3&ct=134217728&hl=zh-CN&ie=utf-8&ei=utf-8&lm=-1&word={key}"], ["雅虎", "http://music.yahoo.cn/s?q={key}"], ["有道", "http://mp3.youdao.com/search?q={key}{encode}"], ["搜狗", "http://mp3.sogou.com/music.so?&class=1&p=40010200&query={key}"], ["搜搜", "http://cgi.music.soso.com/fcgi-bin/m.q?w={key}"]]],
        pic: ["pic", "图片", [["中搜", "http://img.zhongsou.com/i?w={key}"],["Bing", "http://cn.bing.com/images/search?q={key}"],["雅虎", "http://image.yahoo.cn/s?q={key}"], ["有道", "http://image.youdao.com/search?q={key}"], ["搜狗", "http://pic.sogou.com/pics?query={key}"]]],
        buy: ["buy", "购物", [["淘宝网", "http://z.alimama.com/tksEncrypt.php?q={key}&cat=0&pid=mm_13556180_0_0&unid=&commend=all&search_type=auction&user_action=initiative&f=D9_5_1&at_topsearch=1&sid=%28c1954a011125e5122c952bf50edbca25%29&sort=&spercent=0&st=0"], ["阿里巴巴", "http://search.china.alibaba.com/search/offer_search.htm?keywords={key}&x=0&y=0"],["京东", "http://search.360buy.com/Search?keyword={key}&enc=utf-8"],["惠惠", "http://www.huihui.cn/search?q={key}"], ["鲜花礼品", "http://www.flowercn.com/search.asp?search_usage=&search_price=&search_keyword={key}&imageField3.x=0&imageField3.y=0"]]],
        book: ["book", "图书", [["博库书城", "http://www.bookuu.com/search/book_search.jsp?category=gjz&keyword={key}"],["豆丁", "http://www.docin.com/app/searchnew/findproduct?keyword={key}{encode}"], ["百度", "http://www.baidu.com/baidu?q1={key}"], ["搜狗", "http://www.sogou.com/web?query=filetype%3Aall+{key}&filetype=all"], ["爱问", "http://ishare.iask.sina.com.cn/search.php?key={key}&format="], ["牛档", "http://www.niudown.com/search.aspx?keyword={key}{encode}"],["起点", "http://sosu.qidian.com/search.aspx?k={key}&t=zh"]]],
        map: ["map", "地图", [["我要地图", "http://www.51ditu.com/maps?wd={key}"], ["百度", "http://map.baidu.com/#word={key}&ct=10&bs=010"],["Bing", "http://cn.bing.com/ditu/?q={key}"],  ["有道", "http://ditu.youdao.com/search?q={key}"], ["搜狗", "http://map.sogou.com/index.html#lq={key}"]]],
        news: ["news", "资讯", [["中搜", "http://zixun.zhongsou.com/n?w={key}"],["百度", "http://news.baidu.com/ns?cl=2&rn=20&tn=news&word={key}"], ["雅虎", "http://one.cn.yahoo.com/s?p={key}&v=news"], ["有道", "http://news.youdao.com/search?q={key}"], ["搜狗", "http://news.sogou.com/news?query={key}"]]],
        know: ["know", "知识", [["百度", "http://zhidao.baidu.com/q?word={key}&ct=17&pn=0&tn=ikaslist&rn=10&lm=0&fr=search"], ["雅虎", "http://one.cn.yahoo.com/s?p={key}&pid=hp&v=ks"],["天涯", "http://wenda.tianya.cn/wenda/search?q={key}{encode}"], ['搜搜', 'http://wenwen.soso.com/z/SearchSolved.e?sp=S{key}&w={key}&search=%E6%90%9C%E7%B4%A2%E7%AD%94%E6%A1%88{encode}']]]
    },
    init: function() {
        var H = G.SO.initData;
        ...
        for (var B in H) {
            try {
                ...
                D += '</ul><input type="hidden" id="' + E[0] + '_hid" value="' + A[0][1] + '"/><div class="searchCont"><input id="' + E[0] + '_txt" type="text" text="请输入搜索关键字" class="text" onkeydown="if(event.keyCode == 13){this.nextSibling.onclick();}" onfocus="this.select();"/><img src="style/images/search_image.gif" onclick="G.SO.go(\'' + E[0] + "');\"/></div></div></div></div>"
            } catch(I) {
                alert(I)
            }
        }
    ...
    go: function(B) {
       ...
       // window.open(C)
	   document.getElementById("baidu_1").style.display="none";
	   document.getElementById("baidu_2").style.display="none";
	   document.getElementById("searchLogo").style.display="none";
	   document.getElementById("searchResult").src=C;
	   //IFrameReSize("searchResult");
	   //IFrameReSizeWidth("searchResult");
	   //"this.height=searchResult.document.body.scrollHeight"
	  // document.getElementById("searchResult").height = document.getElementById("searchResult").document.body.scrollHeight;
	   document.getElementById("searchResult").style.display="";
	   document.getElementById("searchLine").style.display="";
