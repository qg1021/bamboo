...
<div id="wrapper"> 
		...
		<div id="content"> 
    		...
    		<div class="right_shell"> 
				...
				<form id="inputForm" name="inputForm" action="buy!save.action" method="post">
	    			...
	    			<ul class="form">
	 				...
	 				<p class="button_box">
	 					...
	 					<button class="course_btn_grey" type="button" onclick="location.href='buy.action'">取消</button>&nbsp;
	 				</p> 
	 			</form>
 			</div>
    		<!-- 右侧内容 end --> 
