...
<head>
	...
	function init(){
		if(document.getElementById("isedit").value=='true'){
			...
			$("button[id='sbutton']").attr('disabled',true);
		}
	}
	...
	<div id="wrapper"> 
		...
		<div id="content"> 
    		...
    		<div class="right_shell"> 
				...
				<form id="inputForm" name="inputForm" action="company!save.action" method="post">
	    			...
	    			<ul class="form">
	 				...
	 				<p class="button_box">
	 					<button class="course_btn_orange" id="sbutton" type="button" onclick="onSubmit();">保存</button> &nbsp;
	 					<button class="course_btn_grey" type="button" onclick="location.href='company.action'">取消</button>&nbsp;
	 				</p> 
	 			</form>
 			</div>
    		<!-- 右侧内容 end --> 
