...
<div id="wrapper">
	...
	<div id="content">
		<div class="title">
      		...
      		<ul>
		        <li class="ll"><a href="indexsupply!search.action">供应中心</a></li>
    	...
    	<div class="l_col">
    		<form id="mainForm" name="mainForm" action="indexsupply!search.action">
	        	...
	        	<ul>
	        		<s:iterator value="page.result">
		            	<li title="${title}">
							...
							<a href="indexsupply!input.action?id=${id}" target="_blank"><span class="ll"><img border="0" src="${ctx}/<%=Global.picpath%>/${picurl}" width="150" height="60"/></span></a>
		                    <a href="indexsupply!input.action?id=${id}" target="_blank"><span class="news_fonttitle" title="${title}"><common:cut len="30" string="${title}"/></span></a>
		                    <div>
