...
<div id="wrapper">
	...
	<div id="content">
		<div class="supertitle">
   			<div class="tologin">
         		已经注册过了？现在就去<a href="user/index.action"><span class="red_rectangle">登录&gt;&gt;</span></a>
       		</div>
      		<h2 class="stitle">欢迎注册竹木工艺网</h2>
  		</div>
  		<div class="reg_box"> 
  			<form id="inputForm" name="inputForm" action="register!save.action" method="post">
	    		<input id="id" name="id" type="hidden" value="${id}" size="30"/>
	        		...
	        		<div class="regterm">
	        			<input type="checkbox" checked="checked" id="isread" name="isread"/>
	        			我已经看过并同意《<a href="agreement.jsp" target="_blank">中国竹木工艺网会员注册服务条款</a>》 <span id="error_isread"></span>
	        		</div>
	 				<p class="button_box">
