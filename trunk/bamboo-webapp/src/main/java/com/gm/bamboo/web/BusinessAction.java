 ...
 */
@Namespace("/user")
@Results( { @Result(name = CrudActionSupport.RELOAD, location = "business.action?mtype=${mtype}", type = "redirect") })
public class BusinessAction extends CrudActionSupport<Business>
{
