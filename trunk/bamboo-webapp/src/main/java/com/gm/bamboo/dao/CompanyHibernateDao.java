 ...
 */
@Component
public class CompanyHibernateDao extends HibernateDao<Company, Long> implements
        CompanyDao
{
    /**
     * {@inheritDoc}
     ...
     * 
     * @since 2012-9-15
     * @see com.gm.bamboo.api.CompanyDao#operate(java.util.List, boolean)
     */
    @Override
    public void operate(List<Long> ids, boolean ispublic)
    {
        String hql = "update Company set ispublic = :ispublic where id in(:ids)";
