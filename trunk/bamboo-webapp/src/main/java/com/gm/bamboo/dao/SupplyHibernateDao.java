 ...
 */
@Component
public class SupplyHibernateDao extends HibernateDao<Supply, Long> implements
        SupplyDao
{
     ...
     * 
     * @since 2012-9-10
     * @see com.gm.bamboo.api.SupplyDao#publish(java.util.List,
     *      java.lang.Boolean)
     */
    @Override
    public void publish(List<Long> ids, Boolean isPublish)
    {
        String hql = "update Supply set ispublish = :ispublish , publishdate = :publishdate where id in(:ids)";
